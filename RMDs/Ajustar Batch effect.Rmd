...
pretse_LP$abundance_table <- t(rarefied_abundances_LP) %>% as.data.frame()
```
...
print(adonis_result)
estadisitica_ajuste_batch_df["Sin ajustar", "Batch Varianza"] <- adonis_result$R2[1]* 100
...
print(adonis_result)
estadisitica_ajuste_batch_df["Sin ajustar", "Supervivencia Varianza"] <- adonis_result$R2[1]* 100
...
print(adonis_result)
estadisitica_ajuste_batch_df["ConQuR", "Batch Varianza"] <- adonis_result$R2[1]* 100
...
print(adonis_result)
estadisitica_ajuste_batch_df["ConQuR", "Supervivencia Varianza"] <- adonis_result$R2[1]* 100
...
print(adonis_result)
estadisitica_ajuste_batch_df["SVA", "Batch Varianza"] <- adonis_result$R2[1]* 100
...
print(adonis_result)
estadisitica_ajuste_batch_df["SVA", "Supervivencia Varianza"] <- adonis_result$R2[1]* 100
...
print(adonis_result)
estadisitica_ajuste_batch_df["Combat", "Batch Varianza"] <- adonis_result$R2[1]* 100
...
print(adonis_result)
estadisitica_ajuste_batch_df["Combat", "Supervivencia Varianza"] <- adonis_result$R2[1]* 100
...
# Create a TreeSE
tse <- TreeSummarizedExperiment(
    assays =  SimpleList(counts = combat_edata3),
    colData = DataFrame(pretse_LP$samples_metadata),
    rowData = DataFrame(pretse_LP$tax))
...
print(adonis_result)
estadisitica_ajuste_batch_df["MMUPHin", "Batch Varianza"] <- adonis_result$R2[1]* 100
...
print(adonis_result)
estadisitica_ajuste_batch_df["MMUPHin", "Supervivencia Varianza"] <- adonis_result$R2[1]* 100

...
-   [ ] alpha diversidad entre ellas lp y t1 por pairwise

-   [ ] correlacionar alpha diversidad con covariables?
...
-   [ ] Hacer comparativa de cantidad de phyla, genus, etc en variables de salida (supervivencia, AR, etc)
...
-   metagenomic AND machine learning
